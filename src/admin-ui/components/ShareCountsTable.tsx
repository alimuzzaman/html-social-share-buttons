		...
		return (
			<div className="hss-empty-state">
				<p className="text-sm text-gray-500">
					{ __(
						'No share count data found. Select some posts and refresh to get started.',
			...
			<table className="w-full table-fixed border-collapse border border-gray-200">
				<thead className="bg-gray-50">
					<tr>
						<th
							scope="col"
							className="w-12 px-3 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider border-b border-gray-200"
						>
							<Checkbox
								checked={
						...
						>
							{ __( 'Post Title', 'html-social-share-buttons' ) }
						</th>
						...
						<th
							...
							className="px-3 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider border-b border-gray-200"
						>
							{ __( 'Total', 'html-social-share-buttons' ) }
						</th>
						<th
							scope="col"
							className="px-3 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider border-b border-gray-200"
						...
						<th
							...
							className="px-3 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider border-b border-gray-200"
						>
							{ __( 'Actions', 'html-social-share-buttons' ) }
						</th>
					</tr>
				</thead>
