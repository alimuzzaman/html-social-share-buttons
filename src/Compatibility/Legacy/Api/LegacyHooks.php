...
final class LegacyHooks {
	...
	public static function shareTemplates( array $templates ) {
		return self::canonical( 'share_templates', $templates, function ( $value ) {
	...
	public static function shareTemplate( $template, $platform, $fallback = '' ) {
		return self::canonical( 'share_template', $template, function ( $value ) use ( $platform, $fallback ) {
			$hooks = LegacyApi::extensions();
	...
	public static function title( $title ) {
		return self::canonical( 'share_title', $title, function ( $value ) {
			$hooks = LegacyApi::extensions();
	...
	public static function url( $url ) {
		return self::canonical( 'share_url', $url, function ( $value ) {
			$hooks = LegacyApi::extensions();
