...
import { FormField, Select, Checkbox, Button, LoadingOverlay } from '../ui';
			...
			<div className="general-tab">
				<div className="bg-white border border-gray-200 rounded shadow-sm p-6">
					...
					<p className="text-gray-600 mb-6">
						Configure where the social share buttons should appear
						by default.
					</p>
					...
					<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
						<div className="space-y-4">
							...
							>
								<Checkbox
									checked={
										settings.show_on_front_page || false
									}
									onChange={ ( checked ) =>
										updateSetting(
											'show_on_front_page',
							...
							>
								<Checkbox
									checked={
										settings.show_on_archives || false
									}
									onChange={ ( checked ) =>
										updateSetting(
											'show_on_archives',
					...
					<div className="mt-8 pt-4 border-t border-gray-200">
						<div className="flex justify-between items-center">
							<p className="text-sm text-gray-600">
								These settings will be applied as defaults for
